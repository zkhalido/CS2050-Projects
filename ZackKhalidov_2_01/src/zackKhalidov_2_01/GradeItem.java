...
public class GradeItem 
{
	...
	private boolean result = false; // return variable for equal method
	...
	public boolean equals (GradeItem other) {	
		...
		if (gradeItemId == other.gradeItemId && maximumScore == other.maximumScore
		    && actualScore == other.actualScore) {
			result = true;
		} // end if
			
		if (studentId.equals(other.studentId) && courseId.equals(other.courseId)
				&& itemType.equals(other.itemType) && date.equals(other.date)) {
			result = true;
		} // end if
